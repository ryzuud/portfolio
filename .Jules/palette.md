...
## 2024-06-07 - Mobile Menu Keyboard Accessibility
**Learning:** Found that custom mobile menus lack keyboard accessibility by default, particularly the ability to dismiss them with the Escape key. Without this, keyboard users can become trapped in the menu or struggle to return to their previous context.
**Action:** Always implement an event listener for custom mobile menus allowing them to be closed with the 'Escape' key, and verify that focus correctly returns to the toggle button upon closing.
