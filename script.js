...
const translations = {
  fr: {
    ...
    "about.intro":
      'Étudiant en ingénierie <span class="highlight">CyberData</span> à l\'ENSIBS de Vannes, spécialisé en <span class="highlight">cybersécurité</span> et <span class="highlight">sciences des données</span>, passionné par l\'innovation et les technologies avancées.',
    "about.p2":
      "Avec des expériences chez <strong>Orange Innovation</strong> et le <strong>Groupe Crédit Agricole</strong>, j'ai développé des compétences solides en développement d'applications web intégrant l'IA, en automatisation de processus et en analyse de données.",
    "about.p3":
      "Motivé par les défis technologiques, je m'engage à développer des solutions innovantes et performantes dans le domaine des données et de la cybersécurité.",
    ...
    "exp.orange_a1":
      "Développement d'une page web avec <strong>Python et IA</strong> intégrant des solutions d'intelligence artificielle",
    "exp.orange_a2":
      "Analyse et optimisation des <strong>métadonnées</strong> grâce à des outils d'IA",
    "exp.orange_a3":
      "Étude approfondie sur le <strong>comportement des IA</strong> en fonction des prompts",
    "exp.orange_a4":
      "Analyse et évaluation de <strong>modules de langue</strong> avec mesure du taux de confiance",
    "exp.ca1_title": "Développeur SQL Server & PowerShell",
    "exp.ca1_badge": "CDD",
    "exp.ca1_dates": "Juil. 2024 — Août 2024",
    "exp.ca1_duration": "2 mois",
    "exp.ca1_a1":
      "Automatisation du <strong>suivi des temps</strong> de travail avec SQL Server et PowerShell",
    "exp.ca1_a2":
      "<strong>Stratification des problèmes</strong> pour classification et priorisation",
    "exp.ca1_a3":
      "Optimisation du code pour améliorer la <strong>maintenabilité</strong>",
    "exp.ca2_title": "Développeur VBA",
    "exp.ca2_badge": "Stage",
    "exp.ca2_dates": "Avr. 2024 — Juin 2024",
    "exp.ca2_duration": "3 mois",
    "exp.ca2_a1":
      "Automatisation de l'<strong>analyse de données</strong> avec des macros VBA",
    "exp.ca2_a2":
      "<strong>Génération automatique de factures</strong> selon le type de client et service",
    "exp.ca2_a3":
      "<strong>Transformation de données</strong> pour intégration dans les systèmes existants",
    ...
    "edu.ensibs_desc":
      "Formation en ingénierie spécialisée en cybersécurité et sciences des données.",
    "edu.iut_degree": "D.U.T. — Science des Données (ex-STID)",
    "edu.iut_dates": "Sept. 2022 — Juin 2024",
    "edu.iut_desc":
      "Formation en statistiques et traitement informatique des données.",
    ...
    // Footer
    "footer.text":
      'Conçu et développé avec <span class="footer-heart">❤️</span> par Lounès COURIO',
  ...
  en: {
    ...
    "about.intro":
      '<span class="highlight">CyberData</span> Engineering student at ENSIBS (Vannes, France), specializing in <span class="highlight">cybersecurity</span> and <span class="highlight">data science</span>, passionate about innovation and cutting-edge technologies.',
    "about.p2":
      "With professional experience at <strong>Orange Innovation</strong> and <strong>Crédit Agricole Group</strong>, I have built strong skills in AI-powered web development, process automation, and data analysis.",
    "about.p3":
      "Driven by technological challenges, I am committed to building innovative and high-performance solutions in the fields of data and cybersecurity.",
    ...
    "exp.orange_a1":
      "Web page development with <strong>Python & AI</strong>, integrating artificial intelligence solutions",
    "exp.orange_a2":
      "Analysis and optimization of <strong>metadata</strong> using AI-powered tools",
    "exp.orange_a3":
      "In-depth study on <strong>AI behavior</strong> based on prompt engineering",
    "exp.orange_a4":
      "Analysis and evaluation of <strong>language models</strong> with confidence score measurement",
    ...
    "exp.ca1_a1":
      "Automation of <strong>time tracking</strong> with SQL Server and PowerShell",
    "exp.ca1_a2":
      "<strong>Issue stratification</strong> for classification and prioritization",
    "exp.ca1_a3":
      "Code optimization to improve <strong>maintainability</strong>",
    "exp.ca2_title": "VBA Developer",
    "exp.ca2_badge": "Internship",
    "exp.ca2_dates": "Apr. 2024 — Jun. 2024",
    "exp.ca2_duration": "3 months",
    "exp.ca2_a1":
      "Automation of <strong>data analysis</strong> using VBA macros",
    "exp.ca2_a2":
      "<strong>Automated invoice generation</strong> based on client and service type",
    "exp.ca2_a3":
      "<strong>Data transformation</strong> for integration into existing systems",
    ...
    "edu.ensibs_desc":
      "Engineering program specializing in cybersecurity and data science.",
    ...
    "contact.desc":
      "Have an interesting project or opportunity? Don't hesitate to reach out!",
    "contact.email_value": "couriolounes@gmail.com",
    ...
    // Footer
    "footer.text":
      'Designed and developed with <span class="footer-heart">❤️</span> by Lounès COURIO',
...
function initNavbar() {
  ...
  // Close menu with Escape key and return focus to toggle
